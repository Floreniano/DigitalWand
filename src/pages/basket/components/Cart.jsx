    ...
    <div className="card__product">
      ...
      <div className="card__product-info">
        ...
        <div className="card__product-cost">
          <div className="card__product-cost-total">
            <span className="card__product-cost-total-price">{totalPrice} ₽</span>
            <div className="card__product-cost-total-count">
              <button
                className="btn-operation minus"
