                ...
                <div class='step'>
                  ...
                  <div class='card'>
                    <div class='card__method'>
                      ...
                      <img class='card__method-icon' src='img/visa.svg' alt='visa'></img>
                    </div>
                  ...
                  <div class='payment_method'>
                    <div class='billing_method'>
                      ...
                      <img class='price-icon' src='img/PayPal.svg' alt='PayPal'></img>
                    </div>
                    ...
                    <div class='billing_method'>
                      ...
                      <img class='price-icon' src='img/Bitcoin_logo.svg' alt='Bitcoin'></img>
                    </div>
                  </div>
                </div>
                <div class='step'>
