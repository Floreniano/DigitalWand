...
export class AuthorizationPage extends Component {
  ...
  authorization(email, password) {
    ...
    if (emailForAuthorization === email && passwordForAuthorization === password.trim()) {
      localStorage.setItem('userID', 1);
      window.location = '/posts';
    }

    const errorOutputPassword = (errPassString) => this.setState({ errorPassword: errPassString });
    const errorOutputEmail = (errEmailString) => this.setState({ errorEmail: errEmailString });
